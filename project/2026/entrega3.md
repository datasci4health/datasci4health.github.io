...
O problema escolhido deve ser no contexto das "ômicas" e a análise de dados deve usar estratégias de Ciência de Redes. Esta entrega final tem a função de apresentar o resultado final dos trabalhos, detalhando seu método e debatendo os achados.
...
* crie uma pasta `project3-final` na raiz do projeto e coloque a terceira entrega dentro desta pasta conforme [Modelo da Terceira Entrega](/resources/templates/2026/project3-final/).

A submissão da entrega 3 será dividida em duas partes: slides até o dia **08/06 às 7:59 am** e texto no GitHub até **17/06**.

A apresentação será no dia da submissão dos slides **08/06** no horário da aula. Cada equipe terá 30 minutos para se apresentar e haverá mais 10 minutos para perguntas/respostas. Todos os membros da equipe devem participar apresentando.
