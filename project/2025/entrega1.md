...
* crie um arquivo README.md na raiz do projeto com os dados da equipe conforme o [Modelo de README](/resources/templates/2025/);
* crie uma pasta `project1` na raiz do projeto e coloque a primeira entrega dentro desta pasta conforme [Modelo da Primeira Entrega](/resources/templates/2025/project1/).

A submissão da entrega 1 deve ser até o dia **03/09 às 7:59 am**.

A apresentação será neste mesmo dia **03/09** no horário da aula. Cada equipe terá 10 minutos para se apresentar e haverá mais 5 minutos para perguntas/respostas. Todos os membros da equipe devem participar apresentando.
