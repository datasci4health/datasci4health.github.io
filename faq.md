...
Sim. As aulas serão segundas e quartas das 14h às 16h. Veja detalhes de cronograma e local na página de [Orientações Iniciais](landing.md).
...
Se o prazo de matrícula regular se encerrou e você tiver interesse em cursar a disciplina, ainda é possível inscrever-se na alteração de matrícula. Se a alteração de matrícula acontecer depois do início das aulas, você pode começar a cursá-la antes, mesmo que esteja aguardando o período de alteração. Se você não for aluno de computação, biologia ou saúde, é importante que me escreva um e-mail antes de se matricular.

**Sou aluno da disciplina, como entro no Ambiente Virtual Google Classroom?**

A sala virtual fica no Google Classroom [neste link](https://classroom.google.com/c/ODQwMTg4NTgxMDMz). Você deverá fazer login com seu email UNICAMP (email @dac.unicamp.br) para acessar. Se você é um aluno especial, deve buscar acesso ao seu e-mail UNICAMP junto à DAC.
